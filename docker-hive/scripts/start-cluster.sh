...
ssh root@linux121  "nohup /opt/hoult/servers/hive-2.3.7/bin/hive --service metastore &" ## 远程模式启动hive的元数据服务
ssh root@linux123  "nohup /opt/hoult/servers/hive-2.3.7/bin/hive --service metastore &" ## 远程模式启动hive的元数据服务
